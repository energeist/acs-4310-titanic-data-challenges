...
describe('Challenge 2 Titanic', () => {
	...
	test('Test normalizeProperty', () => {
		...
		expect(index.normalizeProperty(data, 'age').length).toEqual(normalizedAges.length)
		expect(index.normalizeProperty(data, 'fare').length).toEqual(normalizedFares.length)
